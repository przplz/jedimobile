...
def setup():
    _headset = mindwave.Headset(_device, '625f') # stiamo dicendo cos'e' l'headset e da quale device prende i valori
    time.sleep(3) # in python sono secondi, serve per aspettare che il MindWave sia pronto
